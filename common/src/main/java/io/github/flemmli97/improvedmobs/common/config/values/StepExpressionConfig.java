...
public class StepExpressionConfig {
    ...
    public static final Value DIFFICULTY_DEFAULT = new Value(0, new ExpressionConfig("difficulty + 0.01"));
    public static final Value ENCHANT_DEFAULT = new Value(0, new ExpressionConfig("0"));
