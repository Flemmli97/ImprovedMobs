...
public class ConfigHandler {
	...
	public static void loadConfig(Configuration config) {
		...
		config.addCustomCategoryComment("general", "This mod uses a increasing difficulty value. The value roughly increases by 1% (1.1% on hard mode) each passing day. \"Difficulty value\" reference to this number.");
		...
		multiplierChance = config.getFloat("Difficulty Multiplier", "general", 1,0,10, "Multiplier on difficulty increase used in equipment events. Causes mobs to have more and better equipment adding to base chance. Set to 0 to disable.");
		enchantChance = config.getFloat("Enchanting Chance", "general", 0.2F, 0, 1, "Chance for each armor pieces to get enchanted. Level increases with difficulty.");
		...
		speedIncrease = getFloatConfig(config, "Speed Increase", "mob attributes", 0.25F, "Speed will be increased by (difficulty value*this) every day. Set to 0 to disable."); 
