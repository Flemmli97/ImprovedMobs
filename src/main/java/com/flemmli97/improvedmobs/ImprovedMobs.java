...
@Mod(modid = ImprovedMobs.MODID, name = ImprovedMobs.MODNAME, version = ImprovedMobs.VERSION, guiFactory = "com.flemmli97.improvedmobs.GuiFactory", dependencies = "required:tenshilib@[1.0.0,);")
