...
public class IMAttributes {
    ...
    public static void apply(MobEntity entity, Attribute att, float value) {
        entity.getPersistentData().putFloat(ImprovedMobs.MODID + ":" + att.id, (att == Attribute.PROJ_BOOST ? 1 : 0) + value);
