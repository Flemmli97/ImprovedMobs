...
public class EntityAITechGuns extends EntityAIBase{
	...
	public static void applyAI(EntityLiving e)
	{
		...
		if (item instanceof GenericGun) {
			...
			e.tasks.addTask(0, new EntityAITechGuns(e, time/3, time, gun.getAI_attackRange(), 
					ReflectionUtils.getFieldValue(AI_burstCount, gun), ReflectionUtils.getFieldValue(AI_burstAttackTime, gun)));
		}
	}
}
