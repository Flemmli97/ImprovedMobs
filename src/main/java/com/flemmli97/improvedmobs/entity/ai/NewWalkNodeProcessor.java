...
public class NewWalkNodeProcessor extends WalkNodeProcessor{
	...
	public int findPathOptions(PathPoint[] pathOptions, PathPoint currentPoint, PathPoint targetPoint, float maxDistance)
    {
        ...
        if (flag && flag3)
        {
			...
			if (!this.entity.worldObj.collidesWithAnyBlock(aabb1) && !this.entity.worldObj.collidesWithAnyBlock(aabb2) &&pathpoint4 != null && !pathpoint4.visited && pathpoint4.distanceTo(targetPoint) < maxDistance)
            {
        ...
        if (flag && flag2)
        {
			...
			AxisAlignedBB aabb1 = new AxisAlignedBB(currentPoint.xCoord+1 - d1 + 0.5D, currentPoint.yCoord + 1.001D, currentPoint.zCoord - d1 + 0.5D, currentPoint.xCoord+1 + d1 + 0.5D, ((float)currentPoint.yCoord + 1+this.entity.height), currentPoint.zCoord + d1 + 0.5D);
			AxisAlignedBB aabb2 = new AxisAlignedBB(currentPoint.xCoord - d1 + 0.5D, currentPoint.yCoord + 1.001D, currentPoint.zCoord-1 - d1 + 0.5D, currentPoint.xCoord + d1 + 0.5D, ((float)currentPoint.yCoord + 1+this.entity.height), currentPoint.zCoord-1 + d1 + 0.5D);
			if (!this.entity.worldObj.collidesWithAnyBlock(aabb1) && !this.entity.worldObj.collidesWithAnyBlock(aabb2) &&pathpoint5 != null && !pathpoint5.visited && pathpoint5.distanceTo(targetPoint) < maxDistance)
            {
        ...
        if (flag1 && flag3)
        {
			...
			AxisAlignedBB aabb1 = new AxisAlignedBB(currentPoint.xCoord-1 - d1 + 0.5D, currentPoint.yCoord + 1.001D, currentPoint.zCoord - d1 + 0.5D, currentPoint.xCoord-1 + d1 + 0.5D, ((float)currentPoint.yCoord + 1+this.entity.height), currentPoint.zCoord + d1 + 0.5D);
			AxisAlignedBB aabb2 = new AxisAlignedBB(currentPoint.xCoord - d1 + 0.5D, currentPoint.yCoord + 1.001D, currentPoint.zCoord+1 - d1 + 0.5D, currentPoint.xCoord + d1 + 0.5D, ((float)currentPoint.yCoord + 1+this.entity.height), currentPoint.zCoord+1 + d1 + 0.5D);
			if (!this.entity.worldObj.collidesWithAnyBlock(aabb1) && !this.entity.worldObj.collidesWithAnyBlock(aabb2) &&pathpoint6 != null && !pathpoint6.visited && pathpoint6.distanceTo(targetPoint) < maxDistance)
            {
        ...
        if (flag1 && flag2)
        {
			...
			AxisAlignedBB aabb1 = new AxisAlignedBB(currentPoint.xCoord+1 - d1 + 0.5D, currentPoint.yCoord + 1.001D, currentPoint.zCoord - d1 + 0.5D, currentPoint.xCoord+1 + d1 + 0.5D, ((float)currentPoint.yCoord + 1+this.entity.height), currentPoint.zCoord + d1 + 0.5D);
			AxisAlignedBB aabb2 = new AxisAlignedBB(currentPoint.xCoord - d1 + 0.5D, currentPoint.yCoord + 1.001D, currentPoint.zCoord+1 - d1 + 0.5D, currentPoint.xCoord + d1 + 0.5D, ((float)currentPoint.yCoord + 1+this.entity.height), currentPoint.zCoord+1 + d1 + 0.5D);
			if (!this.entity.worldObj.collidesWithAnyBlock(aabb1) && !this.entity.worldObj.collidesWithAnyBlock(aabb2) && pathpoint7 != null && !pathpoint7.visited && pathpoint7.distanceTo(targetPoint) < maxDistance)
            {
