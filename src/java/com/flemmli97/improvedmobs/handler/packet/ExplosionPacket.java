...
public class ExplosionPacket  implements IMessage{
	...
	public static class Handler implements IMessageHandler<ExplosionPacket, IMessage> {
        ...
        public IMessage onMessage(ExplosionPacket msg, MessageContext ctx) {
        		MobExplosion explosion = new MobExplosion(Minecraft.getMinecraft().theWorld, (Entity)null, msg.getX(), msg.getY(), msg.getZ(), msg.getStrength(), msg.getAffectedBlockPositions());
            explosion.doExplosionB(true);
            Minecraft.getMinecraft().thePlayer.motionX += (double)msg.getMotionX();
            Minecraft.getMinecraft().thePlayer.motionY += (double)msg.getMotionY();
            Minecraft.getMinecraft().thePlayer.motionZ += (double)msg.getMotionZ();	
            return null;
        }
    }
}
