...
public class EntityAIBlockBreaking extends EntityAIBase{
	...
	public void updateTask() {
		...
		float str = GeneralHelperMethods.getBlockStrength(this.living, state, living.worldObj, markedLoc, false) * (digTick + 1);
		if(str >= 1F)
		{
			digTick = 0;
		...
		} else
		{
			if(digTick%5 == 0)
			{
				...
				living.worldObj.playSound(null, markedLoc, SoundEvents.BLOCK_NOTE_BASS, SoundCategory.BLOCKS, 2F, 0.5F);
				...
				living.worldObj.sendBlockBreakProgress(living.getEntityId(), markedLoc, (int)(str)*digTick*10);
			}
		}
	}
