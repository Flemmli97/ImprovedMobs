...
public class EntityMobSplash extends EntityPotion{
	...
	protected void onImpact(RayTraceResult result) {
		if (!this.worldObj.isRemote)
        {
            ...
            this.worldObj.playEvent(i, new BlockPos(this), PotionType.getID(potiontype));
            this.setDead();
        }
	}
	...
	private void applySplashPotion(RayTraceResult result, List<PotionEffect> list) {
        ...
        List<EntityLivingBase> listEntity = this.worldObj.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb);
