...
public class ConfigLoader {
    ...
    public static InteractionResult loadCommon() {
        ...
        Config.CommonConfig.pehkuiWhitelist = specs.pehkuiWhitelist.get();

        Config.CommonConfig.vanillaClamped = specs.vanillaClamped.get();
        Config.CommonConfig.vanillaClampedMax = specs.vanillaClampedMax.get().floatValue();
        ...
        Config.CommonConfig.useRunecraftoryMod = FabricLoader.getInstance().isModLoaded("runecraftory") ? specs.useRunecraftoryMod.get() : Config.IntegrationType.OFF;
        Config.CommonConfig.runecraftoryScale = specs.runecraftoryScale.get().floatValue();
        ...
        Config.CommonConfig.sizeChance = specs.sizeChance.get().floatValue();
        ...
        Config.CommonConfig.breakSpeedBaseMod = specs.breakSpeedBaseMod.get().floatValue();
        Config.CommonConfig.breakSpeedAdd = specs.breakSpeedAdd.get().floatValue();
