...
public final class ConfigSpecs {
    ...
    public final static class CommonConfigVals {
        ...
        public CommonConfigVals(CommentedJsonConfig.Builder builder) {
            ...
            this.explosionIncrease = builder.comment("Explosion Damage will be multiplied by 1 + difficulty*0.0025*x. Set to 0 to disable").defineInRange("Explosion Damage Increase", 1.0, 0, Double.MAX_VALUE);
