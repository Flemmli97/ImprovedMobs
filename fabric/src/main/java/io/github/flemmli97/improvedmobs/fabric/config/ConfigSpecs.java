...
public final class ConfigSpecs {
    ...
    public final static class CommonConfigVals {
        ...
        public final CommentedVal<Config.DifficultyType> difficultyType;
        ...
        public CommonConfigVals() {
            ...
            this.difficultyType = builder.comment("How the difficulty at a position is calculated. Supported values are: ",
                    ...
                    "PLAYERMEAN: Average difficulty of players in a 128 radius around the position").define("Difficulty type", Config.DifficultyType.GLOBAL);
